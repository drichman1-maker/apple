...
/**
 * Simple, reliable custom dropdown for sorting
 * Uses absolute positioning and click-outside detection
 * No native select element - complete control over styling
 */
